...
[UpdateBefore(typeof(DotsNetKit191GhostSendSystem))]
public class LoadRemoteLevelSystem : ComponentSystem
{
    ...
    protected override void OnUpdate()
    {
        ...
        for (int i = 0; i < entities.Length; ++i)
        {
            ...
            // Load level RPC
            var rpcLoadLevelQueue = ClientServerSystemManager.serverWorld.GetOrCreateSystem<DotsNetKit191RpcSystem>().GetRpcQueue<RpcLoadLevel>();
